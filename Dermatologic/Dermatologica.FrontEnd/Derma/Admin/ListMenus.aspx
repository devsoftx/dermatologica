...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <telerik:RadAjaxManager ID="RadAjaxManager" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="gvMenus" EventName="gvPersons_RowCommand">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="pnlReport" LoadingPanelID="rlpLoading" />
                </UpdatedControls>
            </telerik:AjaxSetting>            
            <telerik:AjaxSetting AjaxControlID="gvMenus" EventName="gvPersons_PageIndexChanging">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="pnlReport" LoadingPanelID="rlpLoading" />
                </UpdatedControls>
            </telerik:AjaxSetting>            
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:GridView ID="gvMenus" runat="server" AutoGenerateColumns="False" OnRowCommand="gvMenus_RowCommand"
                                    ...
                                    AllowPaging="True" onpageindexchanging="gvMenus_PageIndexChanging" >
