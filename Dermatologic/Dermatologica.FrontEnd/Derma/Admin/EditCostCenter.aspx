<%@ Page Title="" Language="C#" MasterPageFile="~/Derma/Derma.master" AutoEventWireup="true" CodeFile="EditCostCenter.aspx.cs" Inherits="Derma_Admin_EditCostCenter" %>
        ...
        <table class="style1">
            <tr>
                ...
                <td style="font-weight: bold; background-color: #006699; color: #FFFFFF; text-align: center;" 
                    colspan="2">
                    Mantenimiento de Centro de Costo</td>
            </tr>
            <tr>
                <td class="style10">
                    &nbsp;</td>
