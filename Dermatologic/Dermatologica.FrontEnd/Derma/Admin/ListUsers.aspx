<%@ Page Title="" Language="C#" MasterPageFile="~/Derma/Derma.master" AutoEventWireup="true"
    CodeFile="ListUsers.aspx.cs" Inherits="Derma_Admin_ListUsers" %>
                        ...
                        <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" OnRowCommand="gvUsers_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Rol Asignado">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="lnkRol" runat="server" NavigateUrl='<%# string.Format("{0}/Derma/Admin/UsersInRoles.aspx?userId={1}", ConfigurationManager.AppSettings["path"],Eval("ProviderUserKey"))  %>'
                                            Text="Rol" />
                                    </ItemTemplate>
                                </asp:TemplateField>
